    ...
    <div className="p-7 bg-white rounded-md shadow-xl w-full max-w-3xl">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
       ...
       {transferType === "local" && (
        <>
         <div>
         <label htmlFor="accountName" className="block font-medium mb-1">Account Name</label>
         <input
             name="accountName"
        ...
        <div>
            <label htmlFor="bankName" className="block font-medium mb-1">Account Number</label>
            <input
              name="bankName"
          ...
          <div>
          <label htmlFor="transferType" className="block font-medium mb-1">Transfer Type</label>
        <select 
          name="transferType" 
          className="w-full border rounded px-3 py-2 outline-none border-gray-300" 
          ...
          <div>
                ...
                <div className="relative">
                  ...
                  <input
                    name="amount"
                    placeholder="Amount"
                    className={`w-full border rounded px-3 py-2 outline-none border-gray-300 ${transferType === "local" ? "pl-8" : ""}`}
        ...
        {transferType === "international" && (
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="bankAddress" className="block font-medium mb-1">Bank Address</label>
                <input
                  name="bankAddress"
        ...
        {transferType === "international" && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6">
          <div>
            <label htmlFor="swiftCode" className="block font-medium mb-1">SWIFT Code</label>
            <input
              name="swiftCode"
          ...
          <div>
            <label htmlFor="ibanNumber" className="block font-medium mb-1">IBAN Number</label>
            <input
              name="ibanNumber"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    name="amount"
                    placeholder="Amount"
                    className={`w-full border rounded px-3 py-2 outline-none border-gray-300 ${transferType === "international" ? "pl-8" : ""}`}
                    value={formData.amount || ''}
                    onChange={handleChange}
                  />
                </div>
